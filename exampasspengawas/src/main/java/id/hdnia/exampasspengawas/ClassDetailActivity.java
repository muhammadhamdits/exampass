...
public class ClassDetailActivity extends AppCompatActivity {
    ...
    public void init(final JSONObject data){
...
//                Toast.makeText(ClassDetailActivity.this, "Success", Toast.LENGTH_SHORT).show();
                try {
                    Intent intent = new Intent(ClassDetailActivity.this, ScanActivity.class);
                    intent.putExtra("kelas_id", data.getInt("kelas_id"));
                    startActivity(intent);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
